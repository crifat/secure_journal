...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { name: @diary.name, user_id: @diary.user_id } }, as: :json
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { name: @diary.name, user_id: @diary.user_id } }, as: :json
    assert_response 200
  end
